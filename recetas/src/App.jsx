...
function App() {
  const recetas = [
    { nombre: 'Receta de bizcuechelo',<img src="" /> ,ingredientes: ['2 tazas Harina leudante', '1 taza azúcar','1 taza leche','150 cc aceite','2 huevos','Esencia de vainilla','Ralladura de naranja o limón'], pasos: ['Paso 1:Mezclar los huevos, la esencia de Vainilla y la cáscara de naranja', 'Paso 2:Colocar el aceite, azúcar y la leche y mezclar', 'Paso 3:Colocar las 2 tazas de harina y mezclar hasta que no queden grumos','paso 4:Enmantecar y enharinar el molde y colocar la preparación','paso 5:Llevar al horno 160° por 45 minutos o hasta pinchar y que salga seco! IMPORTANTE no abrir el horno'] },
